...
//        }
    ...
    public void visit(ConnectorInitExpr connectorInitExpr) {
        ...
        connectorInitExprObj.addProperty(BLangJSONModelConstants.CONNECTOR_INIT_NAME, connectorInitExpr.getTypeName().getName());
        connectorInitExprObj.addProperty(BLangJSONModelConstants.CONNECTOR_INIT_PACKAGE_NAME, connectorInitExpr.getTypeName().getPackageName());
        connectorInitExprObj.addProperty(BLangJSONModelConstants.CONNECTOR_INIT_PACKAGE_PATH, connectorInitExpr.getTypeName().getPackagePath());
        tempJsonArrayRef.push(new JsonArray());
        ...
        connectorInitExprObj.add(BLangJSONModelConstants.CONNECTOR_INIT_ARGS, tempJsonArrayRef.peek());
        tempJsonArrayRef.pop();
