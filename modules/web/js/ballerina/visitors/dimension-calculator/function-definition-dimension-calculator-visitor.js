...
class FunctionDefinitionDimensionCalculatorVisitor {
    ...
    endVisit(node) {
        ...
        viewState.components['parametersPrefixContainer'] = {};
        viewState.components['parametersPrefixContainer'].w = util.getTextWidth('Parameters: ').w;

        viewState.components['returnTypesPrefixContainer'] = {};
        viewState.components['returnTypesPrefixContainer'].w = util.getTextWidth('Return Types: ').w;
