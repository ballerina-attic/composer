 ...
 * under the License.
 */
define(['lodash', 'd3','log', './simple-statement-view', './../ast/connector-init-expression', './point', 'd3utils', './../ast/ballerina-ast-factory'],
    function (_, d3, log, SimpleStatementView, ConnectorInitExpression, Point, D3Utils, BallerinaASTFactory) {

        var ConnectorInitStatementView = function (args) {
            SimpleStatementView.call(this, args);
            this._connectorView = {};

            if (_.isNil(this._container)) {
                log.error("Container for connector init expression is undefined." + this._container);
                throw "Container for connector init expression is undefined." + this._container;
            }
        ...
        ConnectorInitStatementView.prototype = Object.create(SimpleStatementView.prototype);
        ConnectorInitStatementView.prototype.constructor = ConnectorInitStatementView;


        ConnectorInitStatementView.prototype.init = function(){
        ...
        ConnectorInitStatementView.prototype.setDiagramRenderingContext = function(context){
            this._diagramRenderingContext = context;
        };
        ConnectorInitStatementView.prototype.getDiagramRenderingContext = function(){
            return this._diagramRenderingContext;
        };

        // TODO : Please revisit this method. Needs a refactor
        ConnectorInitStatementView.prototype.drawActionConnections = function(startPoint){
        ...
        ConnectorInitStatementView.prototype.setModel = function (model) {
            var actionInvocationModel = this.getModel();
        ...
        ConnectorInitStatementView.prototype.setConnectorView = function(view){
            this._connectorView = view;
        };
        ConnectorInitStatementView.prototype.getConnectorView = function(){
         ...
         */
        ConnectorInitStatementView.prototype.render = function (renderingContext) {
            var self = this;
        ...
        ConnectorInitStatementView.prototype.renderArrows = function (renderingContext) {
        ...
        ConnectorInitStatementView.prototype.renderProcessorConnectEndPoint = function (renderingContext) {
        ...
        ConnectorInitStatementView.prototype.renderProcessorConnectPoint = function (renderingContext) {
            var boundingBox = this.getBoundingBox();
            var width = boundingBox.w();
            var height = boundingBox.h();
         ...
         */
        ConnectorInitStatementView.prototype.removeArrows = function () {
         ...
         */
        ConnectorInitStatementView.prototype.toGlobalCoordinates = function (point) {
         ...
         */
        ConnectorInitStatementView.prototype.onBeforeModelRemove = function () {
        ...
        ConnectorInitStatementView.prototype.updateStatementText = function (newStatementText, propertyKey) {
            var displayText = this.getModel().getExpression();
            var siblingConnectors = this._parent.getModel().children;
        ...
        return ConnectorInitStatementView;
