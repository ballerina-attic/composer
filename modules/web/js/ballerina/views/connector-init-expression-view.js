...
define(['lodash', 'log', './ballerina-statement-view', './../ast/arithmetic-expression', 'd3utils', 'd3'],
    function (_, log, BallerinaStatementView, ArithmeticExpression, D3Utils, d3) {
         ...
         * @constructor
         */
        var ConnectorInitExpressionView = function (args) {
            BallerinaStatementView.call(this, args);
        };

        ConnectorInitExpressionView.prototype = Object.create(BallerinaStatementView.prototype);
        ...
        ConnectorInitExpressionView.prototype.setContainer = function (container) {
        ...
        ConnectorInitExpressionView.prototype.getModel = function () {
            return this._model;
        };

        ConnectorInitExpressionView.prototype.getContainer = function () {
         ...
         */
        ConnectorInitExpressionView.prototype.render = function () {
            ...
            log.debug("Rendering connector init expression view.");
        ...
        ConnectorInitExpressionView.prototype.updateStatementText = function (updatedText) {
            if (!_.isUndefined(updatedText) && updatedText !== '') {
                this.getStatementGroup().expression_text.node().textContent = updatedText;
            }
        };
        return ConnectorInitExpressionView;
    });