...
class BallerinaFileEditor extends EventChannel {
  ...
  render(diagramRenderingContext) {
      ...
      swaggerViewBtn.click(() => {
          try {
              ...
              var serviceDef = _.find(treeModel.getChildren(), (child) => {
  ...
  generateCurrentPackage() {
      ...
      var currentPackageArray = _.filter(packages, (pkg) => !_.isEmpty(this._model.children) && (pkg.getName() ===  this._model.children[0].getPackageName()));
