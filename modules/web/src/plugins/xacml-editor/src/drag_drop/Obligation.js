...
/**
 * Obligation xacml policy component
 */
class Obligation extends React.Component {
    ...
    submitdata(e) {
        ...
        this.props.onSubmitCondition(attribute_value[1], this.state.valueselect5, this.state.condition_attribute_value, this.state.valueselect6);
    }
    ...
    render() {
        ...
        return (
            <form>
                ...
                <label className='col-sm-6' htmlFor='Obligation'> Obligation:</label>
                <br />
