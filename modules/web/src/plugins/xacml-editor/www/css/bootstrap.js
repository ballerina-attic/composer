    ...
    // private
            ...
            Carousel.prototype._addEventListeners = function _addEventListeners() {
                ...
                if (this._config.pause === 'hover' && !('ontouchstart' in document.documentElement)) {
                    $(this._element).on(Event.MOUSEENTER, (event) => {
                        return _this4.pause(event);
                    }).on(Event.MOUSELEAVE, (event) => {
    ...
    // public
            ...
            Modal.prototype.show = function show(relatedTarget) {
                ...
                $(this._dialog).on(Event.MOUSEDOWN_DISMISS, () => {
                    $(_this9._element).one(Event.MOUSEUP_DISMISS, (event) => {
            ...
            Modal.prototype.hide = function hide(event) {
                ...
                if (transition) {
                    $(this._element).one(Util.TRANSITION_END, (event) => {
    ...
    // private
            ...
            Tooltip.prototype._setListeners = function _setListeners() {
                ...
                triggers.forEach((trigger) => {
                    if (trigger === 'click') {
                        $(_this24.element).on(_this24.constructor.Event.CLICK, _this24.config.selector, (event) => {
                            return _this24.toggle(event);
                        });
                    } else if (trigger !== Trigger.MANUAL) {
                        const eventIn = trigger === Trigger.HOVER ? _this24.constructor.Event.MOUSEENTER : _this24.constructor.Event.FOCUSIN;
                        const eventOut = trigger === Trigger.HOVER ? _this24.constructor.Event.MOUSELEAVE : _this24.constructor.Event.FOCUSOUT;

                        $(_this24.element).on(eventIn, _this24.config.selector, (event) => {
                            return _this24._enter(event);
                        }).on(eventOut, _this24.config.selector, (event) => {
